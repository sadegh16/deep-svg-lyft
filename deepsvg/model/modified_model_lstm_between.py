...
from src.model_and_dataset.models.lstm_encoder_block import EncoderLSTM
...
class Encoder(nn.Module):
    ...
    def forward(self, commands, args, history, label=None):
        ...
        h = self.history_LSTM(history).unsqueeze(0).unsqueeze(0)
        # print(h.shape)
