...
from .my_sem_box_rasterizer import MySemBoxRasterizer
...
def my_build_rasterizer(cfg: dict, data_manager: DataManager) -> Rasterizer:
...
#             )
#         else:
        return MySemanticRasterizer(raster_size, pixel_size, ego_center, semantic_map_filepath,
                                    world_to_ecef,)
