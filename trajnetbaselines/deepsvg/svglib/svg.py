...
class SVG:
    ...
    # Saeed added these removing functions
    def rmv_path_group(self, path_group: SVGPathGroup):
        self.svg_path_groups.remove(path_group)

        return self
    
    def rmv_path_groups(self, path_groups: List[SVGPathGroup]):
        for path_group in path_groups:
            self.rmv_path_group(path_group)
